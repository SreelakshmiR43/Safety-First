...
$sql="select * from tbl_police_station where (station_name='$station_name');";
    ...
    echo "<script>alert('This station is already exist');window.location='adminhome.php'</script>"; 
        ...
        $sql=mysqli_query($conn,"insert into tbl_police_station(station_name,district,city,circle,phn_no,station_mail) values('$station_name','$district','$city','$circle','$phn_no','$station_mail')");
