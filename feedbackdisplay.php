...
<body>
  <div class="sidebar">
   ...
   <br>
   <br>
    <a href="feedback.html" class="button" style = "position:relative; left:710px; top:1px;">Add Feedback</a>
...
?>                                  
              <tr>
               ...
               ?>
               <td><a href="feedbackedit.php?feed_id=<?php echo $row['feed_id']?>">Edit</a></td>
              </tr>
