...
$query="UPDATE tbl_complaint SET `email`='$email',`crime_type`='$crime_type',`description`='$description',`crime_place`='$crime_place' ,`date`='$date ',`image`='$image',`pstation`='$pstation'  where complaint_id='$id'";
$query_run=mysqli_query($conn,$query);
if($query_run)
{
    $_SESSION['status'] = "Complaint updated successfully";
    header('location:complaintadddisplay.php');
}
else
{
    echo "no";
...
<div class="sidebar">
  ...
  <section class="home-section">
    ...
    <div class="content">
      ...
      <form  id="form" name="form"  action="complaint.php" method="post" autocomplete="off">
      <?php
     if(isset($_GET['complaint_id']))
     {
        $complaint_id=$_GET['complaint_id'];

        $query=mysqli_query($conn,"select * from tbl_complaint where complaint_id='$complaint_id'");
...
?>
        ...
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" id="place" name="crime_place" onkeyup="" placeholder="Enter crime place" value="<?=$row['crime_place']?>" required >
    ...
    <div class="user-details">
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" id="pstation" onkeyup="" name="pstation" placeholder="Enter  your police station" value= "<?=$row['pstation']?>"required>
