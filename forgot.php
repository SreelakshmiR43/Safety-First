...
if(isset($_POST['send_otp'])){
    ...
    if($rsltCheck>0){
        ...
        $mail->Username   = 'email';                     //SMTP  username  mail
        $mail->Password   = '###';                               //SMTP password
        $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom('sreelakshmir2023b@mca.ajce.in');
...
<body>
    <div class="navbar">
        <a class="left" href="index.php"><img src="imgs/main-logo.png" alt="" width="200" height="80"></a>
    </div>
